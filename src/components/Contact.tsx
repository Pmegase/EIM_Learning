...
const Contact = () => {
  ...
  return (
    <section
      ...
      style={{
        backgroundImage: `linear-gradient(rgba(0,0,0,0.8), rgba(0,0,0,0.8)), url('/uploads/gallery-3.png')`,
      }}
    >
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 sm:gap-6 lg:gap-8 max-w-6xl mx-auto">
          ...
          <div className="bg-gray-100 p-4 sm:p-6 lg:p-8 rounded-lg">
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <Button type="submit" className="w-full bg-green-600 hover:bg-green-700 text-white font-bold py-3" disabled={isSubmitting}>
            ...
            <div className="space-y-6 sm:space-y-8">
              ...
              <div className="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <a href={`mailto:${content.contactInfo.email}`} className="text-green-600 hover:text-green-800">

...
const faqData = [
  {
    ...
    answer:
      "EIM works with corporate institutions looking for qualified interns and junior-level staff and students, young professionals, and recent graduates in need of career guidance and employability skills training.",
  },
  {
  ...
  },
  {
    ...
    answer:
      "With first-hand experience of the difficulty students face transitioning into the corporate/business world after school, we have researched and identified the right training & guidance programs that we believe will be useful to students once they get into the office.",
  },
  {
    question: "Why should a client choose EIM as a partner to help develop their corporate skill?",
    answer:
      "We provide a platform that facilitates youth leadership and unleashes the potential of the Ghanaian youth using accountability networking, self-development workshops, and global mentorship programs.",
  },
  {
    question: "What are the benefits of learning & development to a student or graduate in the modern workplace?",
    answer:
      "Personal and career development helps you develop new skills and build on old ones, no matter your level of experience. It also gives you an added advantage over other job seekers since every employer today is only looking to hire qualified and experienced personnel.",
  },
  {
  ...
  },
  {
    ...
    answer:
      "Our main goal is to help employees align their goals & performance with that of the company to promote overall business productivity.",
  },
];
          ...
          <div className="container mx-auto max-w-4xl pt-16">
            ...
            <div className="bg-white rounded-lg shadow-lg p-4 sm:p-6 md:p-8">
              {faqData.map((item, index) => (
                <div
                  key={index}
                  className="mb-6 last:mb-0 pb-4 sm:pb-6 last:pb-0 border-b last:border-b-0 border-gray-200"
                >
                  <p className="font-semibold text-base sm:text-lg text-gray-800 mb-2">{item.question}</p>
